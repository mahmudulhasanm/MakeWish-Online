...
public class youtube_policy_monitization extends AppCompatActivity implements View.OnClickListener {
    private static WebView webView;
    private static ProgressBar webViewProgressBar;
    private static ImageView back, forward, refresh, close;
    private static final String webViewUrl = "https://creatoracademy.youtube.com/page/lesson/revenue-basics";
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new youtube_policy_monitization.MyWebViewClient());
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(youtube_policy_monitization.this, "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
