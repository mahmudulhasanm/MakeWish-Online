...
public class AffiliateSite extends AppCompatActivity implements View.OnClickListener {
    private static WebView webView;
    private static ProgressBar webViewProgressBar;
    private static ImageView back, forward, refresh, close;
    private static final String webViewUrl = "https://onlinedropshipbusiness.blogspot.com/p/what-do-you-need-to-make-blogging.html";
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new AffiliateSite.MyWebViewClient());
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(AffiliateSite.this, "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
