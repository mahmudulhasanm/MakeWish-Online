...
public class BloggingSite extends AppCompatActivity implements View.OnClickListener {

    private static WebView webView;
    private static ProgressBar webViewProgressBar;
    private static ImageView back, forward, refresh, close;
    private static final String webViewUrl = "https://onlinedropshipbusiness.blogspot.com/p/make-blog-site.html";
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new BloggingSite.MyWebViewClient());
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(BloggingSite.this, "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
