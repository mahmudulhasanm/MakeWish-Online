...
public class Policy extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String webViewUrl = "https://sites.google.com/view/makewishonline/home";
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new Policy.MyWebViewClient());
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(Policy.this, "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
